...
-- Public booking creation must handle the unique-slot conflict gracefully in the API.
-- Apply this schema once in Supabase SQL Editor before using availability protection.